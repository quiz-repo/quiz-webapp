export const testdata = () => {
  ...
  questions: [
    ...
    {
      id: 3,
      question: "What is the default behavior of `require.cache` in Node.js?",
      options: [
    ...
    {
      id: 7,
      question: "Which method is used to schedule a callback to be invoked in the next iteration of the event loop?",
      options: [
        "setImmediate()",
        "setTimeout()",
        "setInterval()",
    ...
    {
      id: 9,
      question: "Which method is used to gracefully shut down a Node.js server?",
      options: [
        "server.shutdown()",
        "server.end()",
        "server.destroy()",
    ...
    {
      id: 10,
      question: "Which module in Node.js provides utilities for working with file and directory paths?",
    ...
    {
      id: 12,
      question: "In Node.js, what is the difference between `fs.readFile()` and `fs.createReadStream()`?",
      options: [
    ...
    {
      id: 14,
      question: "In Node.js, what is the difference between `setTimeout()` and `setImmediate()`?",
      options: [
    ...
    {
      id: 16,
      question: "In Node.js, what is the difference between `Buffer.from()` and `Buffer.alloc()`?",
      options: [
    ...
    {
      id: 18,
      question: "In Node.js, what is the difference between `require()` and `require.resolve()`?",
      options: [
    ...
    {
      id: 20,
      question: "In Node.js, what is the difference between `process.env` and `process.argv`?",
      options: [
    ...
    {
      id: 24,
      question: "In Express.js, what is the difference between `res.send()` and `res.json()`?",
      options: [
    ...
    {
      id: 26,
      question: "In Express.js, what is the difference between `req.params` and `req.query`?",
      options: [
    ...
    {
      id: 30,
      question: "In Express.js, what is the difference between `app.locals` and `res.locals`?",
      options: [
    ...
    {
      id: 32,
      question: "In Express.js, what is the difference between `app.set()` and `app.get()`?",
      options: [
    ...
    {
      id: 36,
      question: "In Express.js, what is the difference between `req.body` and `req.raw`?",
      options: [
    ...
    {
      id: 37,
      question: "What is the purpose of rate limiting in Express.js applications?",
      options: [
    ...
    {
      id: 38,
      question: "In Express.js, what is the purpose of `compression` middleware?",
      options: [
        "To compress images",
    ...
    {
      id: 40,
      question: "In Express.js, what is the difference between `res.redirect()` and `res.render()`?",
      options: [
    ...
    {
      id: 41,
      question: "What is the purpose of validation middleware in Express.js?",
      options: [
    ...
    {
      id: 42,
      question: "In Node.js testing, what is the purpose of `mocha` framework?",
      options: [
        "To serve coffee",
    ...
    {
      id: 43,
      question: "What is the purpose of `chai` assertion library in Node.js testing?",
      options: [
        "To serve tea",
    ...
    {
      id: 45,
      question: "What is the purpose of `supertest` library in Node.js testing?",
      options: [
    ...
    {
      id: 46,
      question: "In Node.js, what is the difference between `npm test` and `npm run test`?",
      options: [
    ...
    {
      id: 47,
      question: "What is the purpose of test coverage in Node.js applications?",
      options: [
    ...
    {
      id: 50,
      question: "In Node.js, what is the difference between `__dirname` and `process.cwd()`?",
      options: [
    ...
    {
      id: 52,
      question: "In Node.js, what is the difference between `spawn()` and `exec()` in child_process?",
      options: [
    ...
    {
      id: 54,
      question: "In Node.js, what is the difference between `readable` and `writable` streams?",
      options: [
    ...
    {
      id: 56,
      question: "In Node.js, what is the difference between `pipe()` and `pipeline()`?",
      options: [
    ...
    {
      id: 60,
      question: "In Node.js, what is the difference between `setImmediate()` and `process.nextTick()`?",
      options: [
    ...
    {
      id: 62,
      question: "In Node.js, what is the difference between `fs.promises` and callback-based fs methods?",
      options: [
    ...
    {
      id: 63,
      question: "What is the purpose of `WeakMap` and `WeakSet` in Node.js memory management?",
      options: [
    ...
    {
      id: 64,
      question: "In Node.js, what is clustering and how does it improve performance?",
      options: [
    ...
    {
      id: 66,
      question: "In Node.js, what is the difference between `JSON.parse()` and `JSON.stringify()`?",
      options: [
    ...
    {
      id: 68,
      question: "In Node.js, what is the difference between `readdir()` and `readDirSync()`?",
      options: [
    ...
    {
      id: 70,
      question: "In Node.js, what is the difference between `url.parse()` and `new URL()`?",
      options: [
    ...
    {
      id: 72,
      question: "In Node.js, what is the difference between `module.exports` and `exports`?",
      options: [
    ...
    {
      id: 76,
      question: "In Node.js, what is the difference between `http` and `https` modules?",
      options: [
    ...
    {
      id: 78,
      question: "In Node.js, what is the difference between `fs.watch()` and `fs.watchFile()`?",
      options: [
    ...
    {
      id: 80,
      question: "In Node.js, what is the difference between `Buffer` and `ArrayBuffer`?",
      options: [
    ...
    {
      id: 82,
      question: "In Node.js microservices, what is the purpose of service discovery?",
      options: [
    ...
    {
      id: 83,
      question: "What is the purpose of circuit breaker pattern in Node.js applications?",
      options: [
    ...
    {
      id: 84,
      question: "In Node.js, what is the difference between `npm install` and `npm ci`?",
      options: [
    ...
    {
      id: 85,
      question: "What is the purpose of `package-lock.json` file in Node.js projects?",
      options: [
    ...
    {
      id: 86,
      question: "In Node.js, what is the difference between `dependencies` and `devDependencies`?",
      options: [
    ...
    {
      id: 87,
      question: "What is the purpose of `npx` command in Node.js ecosystem?",
      options: [
    ...
    {
      id: 88,
      question: "In Node.js, what is the purpose of `semver` (Semantic Versioning)?",
      options: [
        "To handle semesters",
    ...
    {
      id: 89,
      question: "What is the purpose of load balancing in Node.js applications?",
      options: [
    ...
    {
      id: 90,
      question: "In Node.js, what is the difference between horizontal and vertical scaling?",
      options: [
    ...
    {
      id: 91,
      question: "What is the purpose of caching strategies in Node.js applications?",
      options: [
        "To cache money",
    ...
    {
      id: 92,
      question: "In Node.js, what is the difference between Redis and Memcached for caching?",
      options: [
    ...
    {
      id: 93,
      question: "What is the purpose of containerization (Docker) in Node.js deployment?",
      options: [
        "To contain water",
    ...
    {
      id: 95,
      question: "What is the purpose of health checks in Node.js applications?",
      options: [
    ...
    {
      id: 96,
      question: "In Node.js, what is the difference between JWT and session-based authentication?",
      options: [
    ...
    {
      id: 97,
      question: "What is the purpose of graceful shutdown in Node.js applications?",
      options: [
    ...
    {
      id: 98,
      question: "In Node.js, what is the purpose of process managers like PM2?",
      options: [
    ...
    {
      id: 99,
      question: "What is the purpose of database connection pooling in Node.js?",
      options: [
    ...
    {
      id: 100,
      question: "In advanced Node.js applications, what is the purpose of implementing idempotency?",
      options: [
...
},
{
  ...
  questions: [
    ...
    {
      id: 15,
      question: "What is the difference between function components and class components?",
      options: [
    ...
    {
      id: 75,
      question: "What is the difference between SSR and Static Site Generation (SSG)?",
      options: [
    ...
    {
      id: 94,
      question: "What is the difference between React Virtualized and React Window?",
      options: [
